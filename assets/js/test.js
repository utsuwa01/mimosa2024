...
!function() {
    var i;
    function e(i) {
        $("#slideYouTube01")[0].contentWindow.postMessage('{"event":"command","func":"' + i + '","args":""}', "*"),
        $("#slideYouTube02")[0].contentWindow.postMessage('{"event":"command","func":"' + i + '","args":""}', "*"),
        $("#slideYouTube03")[0].contentWindow.postMessage('{"event":"command","func":"' + i + '","args":""}', "*")
    }
    !function() {
        $(window).scroll(function() {
            600 < $(this).scrollTop() ? ($(".js_pagetop").addClass("is_show"),
            $(".js_pagetop").removeClass("is_hide")) : ($(".js_pagetop").addClass("is_hide"),
            $(".js_pagetop").removeClass("is_show"))
        }),
        ...
        var i = $(window).height()
          , e = i - 740;
        i < 750 ? $(".js_hit").css("margin-top", "150px") : $(".js_hit").css("margin-top", e + "px"),
        $(window).resize(function() {
            var i = $(window).height()
              , e = i - 740;
            i < 750 ? ($(".js_hit").css("margin-top", "150px"),
            console.log(i)) : $(".js_hit").css("margin-top", e + "px")
        });
        var s = $(".js_modal")
          , o = $(".js_modalimg");
    ...
    i = function(d) {
        ...
        (l = function(i, e) {
            ...
            s.windowTimer = null,
            t = d(i).data("slick") || {},
            s.options = d.extend({}, s.defaults, e, t),
        ...
        l.prototype.addSlide = l.prototype.slickAdd = function(i, e, t) {
            ...
            if ("boolean" == typeof e)
                ...
                return !1;
            s.unload(),
            "number" == typeof e ? 0 === e && 0 === s.$slides.length ? d(i).appendTo(s.$slideTrack) : t ? d(i).insertBefore(s.$slides.eq(e)) : d(i).insertAfter(s.$slides.eq(e)) : !0 === t ? d(i).prependTo(s.$slideTrack) : d(i).appendTo(s.$slideTrack),
        ...
        l.prototype.animateSlide = function(i, e) {
            ...
            d({
                ...
                step: function(i) {
                    i = Math.ceil(i),
                    !1 === s.options.vertical ? t[s.animType] = "translate(" + i + "px, 0px)" : t[s.animType] = "translate(0px," + i + "px)",
                    s.$slideTrack.css(t)
                },
                complete: function() {
                    e && e.call()
            ...
            i = Math.ceil(i),
            !1 === s.options.vertical ? t[s.animType] = "translate3d(" + i + "px, 0px, 0px)" : t[s.animType] = "translate3d(0px," + i + "px, 0px)",
            s.$slideTrack.css(t),
        ...
        l.prototype.buildRows = function() {
            var i, e, t, s = this, o = document.createDocumentFragment(), n = s.$slider.children();
            if (1 < s.options.rows) {
                for (t = s.options.slidesPerRow * s.options.rows,
        ...
        l.prototype.checkResponsive = function(i, e) {
            var t, s, o, n = this, l = !1, r = n.$slider.width(), a = window.innerWidth || d(window).width();
            ...
            n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
                ...
                n.refresh(i)),
                l = s) : null !== n.activeBreakpoint && (n.activeBreakpoint = null,
        ...
        l.prototype.changeSlide = function(i, e) {
            var t, s, o = this, n = d(i.currentTarget);
            ...
            case "index":
                ...
                o.slideHandler(o.checkNavigable(l), !1, e),
        ...
        l.prototype.getDotCount = function() {
            ...
            if (!0 === i.options.infinite)
                ...
                s = 1 + Math.ceil((i.slideCount - i.options.slidesToShow) / i.options.slidesToScroll);
            return s - 1
        }
        ,
        l.prototype.getLeft = function(i) {
            var e, t, s, o, n = this, l = 0;
            ...
            !0 === n.options.variableWidth && (s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow),
            e = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0,
            !0 === n.options.centerMode && (s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow + 1),
            e = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0,
        ...
        l.prototype.getNavigableIndexes = function() {
            for (var i = this, e = 0, t = 0, s = [], o = !1 === i.options.infinite ? i.slideCount : (e = -1 * i.options.slidesToScroll,
        ...
        l.prototype.getSlideCount = function() {
            var t, s = this, o = !0 === s.options.centerMode ? s.slideWidth * Math.floor(s.options.slidesToShow / 2) : 0;
        ...
        l.prototype.lazyLoad = function() {
            ...
            s <= n.slideCount && s++)),
            e = n.$slider.find(".slick-slide").slice(t, s),
            "anticipated" === n.options.lazyLoad)
                for (var o = t - 1, l = s, r = n.$slider.find(".slick-slide"), a = 0; a < n.options.slidesToScroll; a++)
                    o < 0 && (o = n.slideCount - 1),
                    e = (e = e.add(r.eq(o))).add(r.eq(l)),
                    o--,
                    l++;
            i(e),
        ...
        l.prototype.progressiveLazyLoad = function(i) {
            i = i || 1;
            var e, t, s, o, n, l = this, r = d("img[data-lazy]", l.$slider);
            r.length ? (e = r.first(),
            t = e.attr("data-lazy"),
            s = e.attr("data-srcset"),
            o = e.attr("data-sizes") || l.$slider.attr("data-sizes"),
        ...
        l.prototype.refresh = function(i) {
            var e, t = this, s = t.slideCount - t.options.slidesToShow;
        ...
        l.prototype.registerBreakpoints = function() {
            var i, e, t, s = this, o = s.options.responsive || null;
            if ("array" === d.type(o) && o.length) {
                for (i in s.respondTo = s.options.respondTo || "window",
                o)
                    if (t = s.breakpoints.length - 1,
                    o.hasOwnProperty(i)) {
                        for (e = o[i].breakpoint; 0 <= t; )
                            s.breakpoints[t] && s.breakpoints[t] === e && s.breakpoints.splice(t, 1),
                            t--;
                        s.breakpoints.push(e),
                        s.breakpointSettings[e] = o[i].settings
                    }
        ...
        l.prototype.removeSlide = l.prototype.slickRemove = function(i, e, t) {
            var s = this;
            if (i = "boolean" == typeof i ? !0 === (e = i) ? 0 : s.slideCount - 1 : !0 === e ? --i : i,
            s.slideCount < 1 || i < 0 || i > s.slideCount - 1)
                return !1;
            s.unload(),
            !0 === t ? s.$slideTrack.children().remove() : s.$slideTrack.children(this.options.slide).eq(i).remove(),
            s.$slides = s.$slideTrack.children(this.options.slide),
            s.$slideTrack.children(this.options.slide).detach(),
            s.$slideTrack.append(s.$slides),
            s.$slidesCache = s.$slides,
        ...
        l.prototype.setCSS = function(i) {
            ...
            o[s.positionProp] = i,
            !1 === s.transformsEnabled || (!(o = {}) === s.cssTransitions ? o[s.animType] = "translate(" + e + ", " + t + ")" : o[s.animType] = "translate3d(" + e + ", " + t + ", 0px)"),
            s.$slideTrack.css(o)
        }
        ,
                ...
                for (e in s)
                    if ("array" !== d.type(n.options.responsive))
                        ...
                        for (i = n.options.responsive.length - 1; 0 <= i; )
                            n.options.responsive[i].breakpoint === s[e].breakpoint && n.options.responsive.splice(i, 1),
                            i--;
        ...
        l.prototype.setSlideClasses = function(i) {
            var e, t, s, o, n = this, l = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true");
            n.$slides.eq(i).addClass("slick-current"),
            !0 === n.options.centerMode ? (s = n.options.slidesToShow % 2 == 0 ? 1 : 0,
            o = Math.floor(n.options.slidesToShow / 2),
            !0 === n.options.infinite && (o <= i && i <= n.slideCount - 1 - o ? n.$slides.slice(i - o + s, i + o + 1).addClass("slick-active").attr("aria-hidden", "false") : (e = n.options.slidesToShow + i,
            l.slice(e - o + 1 + s, e + o + 2).addClass("slick-active").attr("aria-hidden", "false")),
            0 === i ? l.eq(l.length - 1 - n.options.slidesToShow).addClass("slick-center") : i === n.slideCount - 1 && l.eq(n.options.slidesToShow).addClass("slick-center")),
            n.$slides.eq(i).addClass("slick-center")) : 0 <= i && i <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(i, i + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : l.length <= n.options.slidesToShow ? l.addClass("slick-active").attr("aria-hidden", "false") : (t = n.slideCount % n.options.slidesToShow,
            e = !0 === n.options.infinite ? n.options.slidesToShow + i : i,
            n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - i < n.options.slidesToShow ? l.slice(e - (n.options.slidesToShow - t), e + t).addClass("slick-active").attr("aria-hidden", "false") : l.slice(e, e + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")),
        ...
        l.prototype.setupInfinite = function() {
            ...
            s.slideCount > s.options.slidesToShow)) {
                ...
                i = s.slideCount; i > s.slideCount - t; --i)
                    e = i - 1,
                    d(s.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e - s.slideCount).prependTo(s.$slideTrack).addClass("slick-cloned");
                for (i = 0; i < t + s.slideCount; i += 1)
                    e = i,
                    d(s.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e + s.slideCount).appendTo(s.$slideTrack).addClass("slick-cloned");
        ...
        l.prototype.swipeDirection = function() {
            var i, e = this, t = e.touchObject.startX - e.touchObject.curX, s = e.touchObject.startY - e.touchObject.curY, o = Math.atan2(s, t);
            return (i = Math.round(180 * o / Math.PI)) < 0 && (i = 360 - Math.abs(i)),
            i <= 45 && 0 <= i || i <= 360 && 315 <= i ? !1 === e.options.rtl ? "left" : "right" : 135 <= i && i <= 225 ? !1 === e.options.rtl ? "right" : "left" : !0 === e.options.verticalSwiping ? 35 <= i && i <= 135 ? "down" : "up" : "vertical"
        }
        ,
        ...
        l.prototype.swipeMove = function(i) {
            var e, t, s, o, n, l = this, r = void 0 !== i.originalEvent ? i.originalEvent.touches : null;
            ...
            (l.touchObject.edgeHit = !1) === l.options.infinite && (0 === l.currentSlide && "right" === t || l.currentSlide >= l.getDotCount() && "left" === t) && (s = l.touchObject.swipeLength * l.options.edgeFriction,
            l.touchObject.edgeHit = !0),
            !1 === l.options.vertical ? l.swipeLeft = e + s * o : l.swipeLeft = e + s * (l.$list.height() / l.listWidth) * o,
        ...
        d.fn.slick = function() {
            for (var i, e = this, t = arguments[0], s = Array.prototype.slice.call(arguments, 1), o = e.length, n = 0; n < o; n++)
                if ("object" == _typeof(t) || void 0 === t ? e[n].slick = new l(e[n],t) : i = e[n].slick[t].apply(e[n].slick, s),
                void 0 !== i)
                    return i;
            return e
        }
    ...
    $(".js_slider").slick({
        ...
        dotsClass: "slidedots",
        arrows: !0,
        prevArrow: '<div class="arrows arrowsprev"></div>',
        nextArrow: '<div class="arrows arrowsnext"></div>'
    }),
    $(".arrows").on("click", function() {
        e("pauseVideo")
    }),
    $(".slidedots li").on("click", function() {
        e("pauseVideo")
    })
}();
